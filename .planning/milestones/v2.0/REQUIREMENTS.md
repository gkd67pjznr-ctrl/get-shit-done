# Requirements Archive: v2.0 Concurrent Milestones
...
- [x] **DASH-02**: `/gsd:progress` reads all active milestone STATUS.md files and renders multi-milestone summary table
...
- [x] **DASH-04**: Old-style projects show single-milestone progress (graceful degrade)
...
- [x] **CNFL-03**: Overlap detection runs automatically during `/gsd:new-milestone` workflow
