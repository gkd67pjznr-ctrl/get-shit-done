 ...
 *
 * Reads `.planning/config.json` from disk (under the `adaptive_learning` key), parses it through
...
export const DEFAULT_CONFIG_PATH = '.planning/config.json';
 ...
 *
 * @param configPath - Path to the config file (default: `.planning/config.json`)
